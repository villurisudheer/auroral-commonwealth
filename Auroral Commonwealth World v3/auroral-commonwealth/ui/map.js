...
export function mapHTML(s){
 ...
 return `<div class="panel"><h2>Auroral Strategic Map</h2><p class="mini">All ${COUNTRIES.length} sovereign-state templates are available. Select any nation for intelligence, relations and diplomatic actions.</p>
 <div class="map-stage">
