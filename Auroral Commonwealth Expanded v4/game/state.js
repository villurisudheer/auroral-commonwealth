...
export function createState(country,difficulty='normal',custom={}){
 ...
 buildings:{roads:1,railways:1,airports:1,ports:1,powerPlants:1,hospitals:1,schools:1,universities:1,factories:1,dataCenters:0,researchCenters:0},notifications:[],achievements:[],history:[],collapseStage:'Stable',autosave:true,settings:{sound:false,music:false,animations:true,notifications:true},lastMonthly:{revenue:0,expenses:0,balance:0,growth:0,interest:0}};
 snapshot(s);return s;
}
